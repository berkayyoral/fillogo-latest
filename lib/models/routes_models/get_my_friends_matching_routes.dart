...
class GetMyFriendsMatchingRoutesResponse {
  ...
  factory GetMyFriendsMatchingRoutesResponse.fromRawJson(String str) =>
...
class GetMyFriendsMatchingResDatum {
  ...
  factory GetMyFriendsMatchingResDatum.fromRawJson(String str) =>
      GetMyFriendsMatchingResDatum.fromJson(json.decode(str));
...
class Matching {
  ...
  factory Matching.fromRawJson(String str) =>
      Matching.fromJson(json.decode(str));
...
class Followed {
  ...
  factory Followed.fromRawJson(String str) =>
      Followed.fromJson(json.decode(str));
...
class Userpostroute {
  ...
  factory Userpostroute.fromRawJson(String str) =>
      Userpostroute.fromJson(json.decode(str));
