      ...
      child: Column(
        ...
        children: [
          ...
          FutureBuilder<GetCarTypesResponse>(
              future:
                  GeneralServicesTemp().makeGetRequest(EndPoint.getCarTypes, {
                          ...
                          return Obx(() => Padding(
                                ...
                                child: MaterialButton(
                                  ...
                                  color: selectedIndex.value == index
                                      ? AppConstants().ltWhite.withOpacity(0.95)
                                      : AppConstants()
                                          .ltWhiteGrey
                                          .withOpacity(0.5),
                                  onPressed: () {
          ...
          CustomRedButton(
            onTap: () async {
              if (brandController.text.isEmpty) {
                UiHelper.showWarningSnackBar(context, 'Marka boş bırakılamaz');
              } else if (modelController.text.isEmpty) {
                UiHelper.showWarningSnackBar(context, 'Model boş bırakılamaz');
              } else if (plateController.text.isEmpty) {
                UiHelper.showWarningSnackBar(context, 'Plaka boş bırakılamaz');
                ...
                GeneralServicesTemp()
                  ...
                  RegisterRequestModel(
                    ...
                    phoneNumberOrMail: registerController.emailController.value,
                  ),
                          ...
                          if (value != null) {
                            ...
                            if (loginResponse.success == 1) {
                              ...
                              LocaleManager.instance.setString(
                                ...
                                loginResponse.data![0].user!.profilePicture!,
                              );
                              LocaleManager.instance.setString(
                                PreferencesKeys.refreshToken,
                                loginResponse.data![0].tokens!.refreshToken!,
                              );
