      ...
      if (fileName.endsWith('.png') ||
        ...
        if (!fileName.endsWith('.mp4') && !fileName.endsWith('.mov')) {
          ...
          CroppedFile? croppedFile = await ImageCropper().cropImage(
            ...
            uiSettings: [
              AndroidUiSettings(
                ...
                hideBottomControls: false, // Kullanıcıya seçenek sun
                lockAspectRatio: false, // Kilidi kaldır
              ),
              IOSUiSettings(
          ...
          PlatformFile platformFile = PlatformFile(
            ...
            name: fileName,
            size: await croppedFile.readAsBytes().then((value) => value.length),
          );

          Get.back();
          return platformFile;
        } else {
          log('Video Seçildi - Boyut: ${fileSize}');
